...
public:	// public member functions
	...
	void setMobile(string mob_prev, string mob_new)		
	{
		...
		{
			cout << endl << "Please check  Old Mobile no";
			_getch();//getch is to hold the screen ( untill user press any key )
		}
	}
...
int main()
{
	...
	user1.setData(121212, "harichselvam",0000, 800.80, "7598068106");
	...
	do
	{
		...
		cout << endl << "****Welcome to OOPS  ATM*****" << endl;
		cout << endl << "Enter Your Holding No : ";	  // asking user to enter account no
		cin >> enterAccountNo;

		cout << endl << "Enter 4 Digit pin PIN :  "; // asking user to enter PIN
		cin >> enterPIN;
